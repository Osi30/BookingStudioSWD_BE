...
import com.studio.booking.services.AdminServiceAssignService;
...
public class AdminServiceAssignServiceImpl implements AdminServiceAssignService {
    private final ServiceAssignRepo serviceAssignRepo;
    private final ServiceRepo serviceRepo;
    private final StudioAssignRepo studioAssignRepo;

    @Override
    public List<AdminServiceAssignResponse> getAll() {
    ...
    @Override
    public List<AdminServiceAssignResponse> getByStudioAssign(String studioAssignId) {
    ...
    @Override
    public List<AdminServiceAssignResponse> getByService(String serviceId) {
    ...
    @Override
    public AdminServiceAssignResponse create(AdminServiceAssignRequest req) {
    ...
    @Override
    public AdminServiceAssignResponse update(String id, AdminServiceAssignRequest req) {
    ...
    private AdminServiceAssignResponse toResponse(ServiceAssign sa) {
        return AdminServiceAssignResponse.builder()
                .id(sa.getId())
