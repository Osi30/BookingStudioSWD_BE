...
public class AdminServiceAssignController {
    private final AdminServiceAssignService service;
    ...
    @PostMapping
    public ResponseEntity<BaseResponse> create(@RequestBody AdminServiceAssignRequest req) {
        return ResponseEntity.ok(BaseResponse.builder()
    ...
    public ResponseEntity<BaseResponse> update(@PathVariable String id,
                                               @RequestBody AdminServiceAssignRequest req) {
        return ResponseEntity.ok(BaseResponse.builder()
                .code(HttpStatus.OK.value())
