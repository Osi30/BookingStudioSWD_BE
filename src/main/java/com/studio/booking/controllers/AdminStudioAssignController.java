...
public class AdminStudioAssignController {
    private final AdminStudioAssignService service;
    ...
    @PostMapping
    public ResponseEntity<BaseResponse> create(@RequestBody AdminStudioAssignRequest req) {
        return ResponseEntity.ok(BaseResponse.builder()
    ...
    public ResponseEntity<BaseResponse> update(@PathVariable String id,
                                               @RequestBody AdminStudioAssignRequest req) {
        return ResponseEntity.ok(BaseResponse.builder()
                .code(HttpStatus.OK.value())
